export const Constants = {
    ...
    KEY_USER_AADHAR_NUMBER:'user_aadhar',
    KEY_USER_MOBILE_NUMBER:'user_mobile',
    KEY_USER_NATIVE_LOCATION:'user_native_location',
    KEY_USER_DOB : 'user_dob',
    KEY_USER_EDU : 'user_edu',
    KEY_USER_LOGIN_STATUS : 'user_login',
    KEY_USER_DEGREE_NAME : 'user_edu_degree',
    KEY_USER_SKILL_NAME : 'user_skill',
    KEY_USER_SKILL_DESC : 'user_skill_desc',
    KEY_JOB_WORK_EXP : 'user_job_exp',
    KEY_USER_JOB_TITLE:'user_job_title',
    KEY_USER_JOB_LOCATION:'user_job_location',
    KEY_USER_SALARY:'user_salary',
    KEY_USER_COMPANY_NAME : 'user_company_name',
